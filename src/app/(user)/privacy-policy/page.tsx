            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 border border-border rounded-lg bg-card">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  platform, process enrollments, and deliver course content.
                </p>
              </div>
              <div className="p-6 border border-border rounded-lg bg-card">
              ...
              <div className="p-6 border border-border rounded-lg bg-card">
                <h3 className="text-lg font-semibold mb-2">To Improve Fermi</h3>
                <p className="text-sm text-muted-foreground">
          ...
          <section className="space-y-8">
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              <p className="text-sm text-muted-foreground">
                ...
                analytics providers) that collect, use, and disclose information
          ...
          <section className="space-y-8">
            ...
            <div className="p-6 border border-border rounded-lg bg-card">
              <p className="text-sm text-muted-foreground">
                ...
                continued use of Fermi after changes are made constitutes
